...
getDataFile("./interface/back_office/thematique.php?type=fourchette&appel="+document.getElementById(appel_req).value+"&idtheme="+document.getElementById("ajout_theme").options[document.getElementById("ajout_theme").options.selectedIndex].value,retour_thematique);
	...
	{
		alert("il faut sélectionner un champ!");
	}
...
{
	raster=document.getElementById("crea_shp").value;
	groupe=document.getElementById("crea_group").value;
}
else
{
...
{
appel_schema();
document.getElementById('postgis').style.visibility='visible';
document.getElementById('raster').style.visibility='hidden';
document.getElementById('wms').style.visibility='hidden';	
}
else if(document.getElementById("crea_type").options[document.getElementById("crea_type").options.selectedIndex].value==1)
{
document.getElementById('postgis').style.visibility='hidden';
document.getElementById('raster').style.visibility='visible';
document.getElementById('wms').style.visibility='hidden';	
}
else
{
document.getElementById('postgis').style.visibility='hidden';
document.getElementById('raster').style.visibility='hidden';
document.getElementById('wms').style.visibility='visible';	
}
}
