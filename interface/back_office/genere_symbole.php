<?php
$font_file  = '../../capm/fonts/'.$_GET['font'].'.ttf' ;
$font_size  = $_GET['size'] ;
$font_color = '#'.$_GET['couleur'];
$background_color = "#".$_GET['fond'];
$transparent_background  = $_GET['fond_transparent'];
$cache_images = true ;
$cache_folder = 'image' ;
...
$cache_filename = $cache_folder . '/' . $_GET['text'] . $extension ;
